...
import { Fragment, ReactNode, useRef, useState, useCallback, FormEvent, useEffect } from 'react'
            ...
            <Box width={"100%"} minHeight={"90vh"} bgcolor={"#e1f7f1"}>
                <Stack direction={"row"} justifyContent={"center"} alignItems={"center"} width={"100%"} height={"90vh"} sx={{
                    ...
                    <Box component={"div"} width={{ xs: "100%", sm: 390 }} bgcolor={"white"} height={{ xs: "100%", sm: "510px" }} sx={{ borderRadius: { xs: 0, sm: 3 }, boxShadow: "0px 0px 129px rgba(0,0,0,0.1),0px 32px 64px -48px rgba(0,0,0,0.5),5px 5px 39px -20px  rgba(0,0,0,0.3)", overflow: "hidden", position: 'relative' }} >
                        <Stack height={"100%"}>
                            <Box component={"div"} className='chatbox_header' sx={{ py: 1, px: 2, justifyContent: "center", alignItems: "center", width: "100%", height: { xs: "7%", sm: "15%" }, background: { sm: "#d14d72" } }}>
                            ...
                            <Divider />
                            <Stack component={"form"} onSubmit={handleSend} direction={"row"} spacing={2} alignItems={"center"} justifyContent={"space-around"} height={{ xs: "13%", sm: "13%" }} >
                                <IconButton
