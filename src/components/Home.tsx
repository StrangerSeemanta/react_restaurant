...
function Home() {
    ...
    return (
        <Fragment>
            <section id="home">
                <Box position={"relative"} sx={{ overflow: "hidden", height: "100vh", background: `url(${Bg}), url(${Doodles})`, backgroundPosition: "right bottom,center", backgroundSize: "contain,cover", backgroundRepeat: "no-repeat,no-repeat", backgroundAttachment: "fixed", m: 0, px: { xs: 2, md: 5 }, py: 5 }}>
